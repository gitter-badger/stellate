...
ActiveRecord::Schema.define(version: 20160217193340) do
  ...
  add_index "relationships", ["source_id", "target_id", "type"], name: "index_relationships_on_source_id_and_target_id_and_type", unique: true, using: :btree
